...
public class H2EmployeeDAOImpl implements EmployeeDAO {
    ...
    public Employee save(Employee employee) {
        this.jdbcTemplate.execute("insert into employee (id,name,dateOfBirth,departmentName) values ("+employee.getId()+",'"+employee.getName()+"','"+employee.getDateOfBirth() + "','" + employee.getDepartmentName()+"');");
    	//this.jdbcTemplate.execute("select * from employee");
    	return employee;
    }
